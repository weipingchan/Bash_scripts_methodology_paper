...
#SBATCH -t 0-15:00 # Runtime in days-hours:minutes
...
matlab -nodisplay -nosplash -nodesktop -r "single_band_AnaWholeSpecimen2('$SPP_MATRICES_DIR','$MORPH_MATRICES_DIR','$MATLAB_CODE_LIBRARY','$RESULT_DIR','$BAND_NO','$REF_THRESHOLD'); exit"
